...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Because nestedFunction is a closure inside of myFunction. Because it is inside, it can call and use the variables that are within its parent function.
...
function summation(number) { // I need to start at zero and then add 1 then 2 then 3 then 4
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerNames = array.map(function(element){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop = array.filter(function(element){
  ...
  */
  ...
  function USApop(array){
    const population = array.reduce(function(acc, item){
  ...
  /* 🦁🦁🦁 Step 1: Create a higher-order function 🦁🦁🦁
    X * Use the higher-order function consume with 3 parameters: a, b and cb
